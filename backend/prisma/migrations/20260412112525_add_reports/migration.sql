-- CreateEnum
CREATE TYPE "ReportReason" AS ENUM ('INAPPROPRIATE_CONTENT', 'COUNTERFEIT_ITEM', 'WRONG_CATEGORY', 'SPAM', 'FRAUD', 'OTHER');

-- CreateEnum
CREATE TYPE "ReportStatus" AS ENUM ('PENDING', 'REVIEWED', 'DISMISSED');

-- AlterTable
ALTER TABLE "Product" ADD COLUMN     "isSuspended" BOOLEAN NOT NULL DEFAULT false;
